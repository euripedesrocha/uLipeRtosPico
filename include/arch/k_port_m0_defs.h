 ...
 * 							ULIPE RTOS PICO
 *
 *  @file k_port_m0_defs.h
 *
 *  @brief specific cortex M0 system control block port file
 *
 *
 */
...
#ifndef __K_PORT_M0_DEFS_H
#define __K_PORT_M0_DEFS_H
...
#define K_PORT_SVC_NVIC_PRIO 		(K_SVC_MAX_PRIO)
#define K_PORT_TICKER_NVIC_PRIO 	(K_SVC_MAX_PRIO - 1)
