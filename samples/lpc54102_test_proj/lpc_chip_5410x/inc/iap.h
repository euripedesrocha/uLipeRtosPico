 ...
 */
uint8_t Chip_IAP_PreSectorForReadWrite(uint32_t strSector, uint32_t endSector) __attribute__ ((section(".ramfunc")));
 ...
 */
uint8_t Chip_IAP_CopyRamToFlash(uint32_t dstAdd, uint32_t *srcAdd, uint32_t byteswrt) __attribute__ ((section(".ramfunc"))) ;
 ...
 */
uint8_t Chip_IAP_EraseSector(uint32_t strSector, uint32_t endSector) __attribute__ ((section(".ramfunc")));
 ...
 *			a multiply of 4
 */
uint8_t Chip_IAP_Compare(uint32_t dstAdd, uint32_t srcAdd, uint32_t bytescmp) __attribute__ ((section(".ramfunc")));
